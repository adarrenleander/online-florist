    ...
    <div class="content-container">
        <form action="/manage-flower-types/update/{{ $flowerType->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label text-md-right">{{ __('Flower Type Id') }}</label>
                <div class="col-md-6">
            ...
            <div class="form-group row">
                <label for="type-name" class="col-md-4 col-form-label text-md-right">{{ __('Flower Type Name') }}</label>
                <div class="col-md-6">
